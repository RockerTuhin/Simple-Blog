...
<html lang="en">
  ...
  <body>
    ...
    <!-- Page Header -->
    <header class="masthead" style="background-image: url('{{ URL::to('public/frontened/img/home-bg.jpg') }}')">
    ...
    <script src="{{ asset('public/frontened/vendor/bootstrap/js/bootstrap.bundle.min.js') }}"></script>

    <!-- Custom scripts for this template -->
    <script src="{{ asset('public/frontened/js/clean-blog.min.js') }}"></script>
